...
class PenggunaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pengguna" do
    assert_difference('Pengguna.count') do
      post pengguna_index_url, params: { pengguna: { email: @pengguna.email, nama_lengkap: @pengguna.nama_lengkap, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update pengguna" do
    patch pengguna_url(@pengguna), params: { pengguna: { email: @pengguna.email, nama_lengkap: @pengguna.nama_lengkap, password: 'secret', password_confirmation: 'secret' } }
